...
<script setup lang="ts">
  ...
  function initMap() {
    ...
    info.value = JSON.stringify(map.toJSON());
...
<style>
  ...
  .info {
    ...
    left: 20px;
    padding: 15px;
    background-image: radial-gradient(hsla(var(--guide-color-comps), 0.08) 1px, transparent 0),
      radial-gradient(hsla(var(--guide-color-comps), 0.04) 1px, transparent 0);
    background-size:
      32px 32px,
      8px 8px;
